...
class SerialReader(Node):
    ...
    def imu_callback(self, msg):
        ...
        self.imu_string = f"{angular_x},{angular_y},{angular_z},{orientation_x},{orientation_y},{orientation_z}#"
        self.serial_port.write(self.imu_string.encode('utf-8'))
        # self.get_logger().info(f"Sent to Arduino: {imu_string.strip()}")
    ...
    def read_serial(self):
        ...
        if self.serial_port.in_waiting > 0:
            try:
                ...
                if '#' in data:
                    data = data.split('#')[0]  # Remove anything after #
